...
class commercesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/commerces')->with('success', 'Post Created');
    }
    ...
    {
        $post = Post::find($id);
        return view('commerces.show')->with('post', $post);
    }
    ...
    public function edit($id)
    {
        ...
        if(auth()->user()->id !==$post->user_id){
            return redirect('/commerces')->with('error', 'Unathorized page');

        }

        return view('commerces.edit')->with('post', $post);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/commerces')->with('success', 'Post Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $post->delete();
        return redirect('/commerces')->with('success', 'Post Deleted');
    }
}
